...
def jogar():
    ...
    if(nivel == 1):
        ...
        print(f"Você escolheu a dificuldade Fácil e tem {total_de_tentativas} tentativas")
    elif(nivel == 2):
        total_de_tentativas: int = 8
        print(f"Você escolheu a dificuldade Médio e tem {total_de_tentativas} tentativas")
    elif(nivel == 3):
        total_de_tentativas: int = 6
        print(f"Você escolheu a dificuldade Difícil e tem {total_de_tentativas} tentativas")
    else:
